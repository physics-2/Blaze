    ...
    public Tuning() {
        super("Select a Tuning OpMode", s -> {
            ...
            s.folder("Automatic", a -> {
                a.add("Forward getVelocity Tuner", ForwardVelocityTuner::new);
                a.add("Lateral getVelocity Tuner", LateralVelocityTuner::new);
                ...
                a.add("Offsets tuner",OffsetsTuner::new);
            });
            s.folder("Manual", p -> {
...
class ForwardVelocityTuner extends OpMode {
    ...
    public void loop() {
        ...
        if (!end) {
            ...
            telemetryM.debug("Forward getVelocity: " + average);
            telemetryM.debug("\n");
            telemetryM.debug("Press A to set the Forward getVelocity temporarily (while robot remains on).");
...
class LateralVelocityTuner extends OpMode {
    ...
    public void loop() {
        ...
        if (!end) {
            ...
            telemetryM.debug("Strafe getVelocity: " + average);
            telemetryM.debug("\n");
            telemetryM.debug("Press A to set the Lateral getVelocity temporarily (while robot remains on).");
            telemetryM.update(telemetry);
...
class ForwardZeroPowerAccelerationTuner extends OpMode {
     ...
     * recorded deceleration / negative acceleration and print that name.
     */
    @Override
    public void loop() {
        if (gamepad1.bWasPressed()) {
